...
system('termux-open-url https://chat.whatsapp.com/LKqLwcRheov1Dlv6HDaFMr &> /dev/null')
sleep(1)
system('termux-open-url https://t.me/clownters &> /dev/null')
sleep(0.5)
#Cores
red='\033[1;31m'
green='\033[1;32m'
...
{yellow} ||\     ______________________
 ...
 {blue}< {red}Arquivo Clownters {blue}>
